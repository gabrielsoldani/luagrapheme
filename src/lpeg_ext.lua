...
lpeg_ext.GraphemeBreak = lpeg.P(luagrapheme.is_grapheme_break)

lpeg_ext.GraphemeCount = function(count)
   local match_count_graphemes = luagrapheme._match_n_graphemes(count)
...
lpeg_ext.GraphemeOneOf = function(...)
   ...
   local match_one_of_graphemes = luagrapheme._match_one_of_graphemes(...)
